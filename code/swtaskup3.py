...
np.save('data/result_weight_globalpre3', result_weight_globalpre)
np.save('data/result_weight_localpre3', result_weight_localpre)
np.save('data/result_reactivation_global3', result_reactivation_global)
np.save('data/result_reactivation_local3', result_reactivation_local)
np.save('data/result_perf3', result_perf)
np.save('data/result_perf_beforesleep3', result_perf_beforesleep)
np.save('data/base_performance3', base_performance)
