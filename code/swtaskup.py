...
np.save('data/result_weight_globalpre', result_weight_globalpre)
np.save('data/result_weight_localpre', result_weight_localpre)
np.save('data/result_reactivation_global', result_reactivation_global)
np.save('data/result_reactivation_local', result_reactivation_local)
np.save('data/result_perf', result_perf)
np.save('data/result_perf_beforesleep', result_perf_beforesleep)
np.save('data/base_performance', base_performance)
